(function(){
  ...
  const radios = Array.from(document.querySelectorAll('input[name="take-img"]'));
  if (radios.length === 0) return;

  function getCurrentIndex(){
    return radios.findIndex(r => r.checked) || 0;
  }
  ...
  function goNext(){ setIndex(getCurrentIndex() + 1); }
  function goPrev(){ setIndex(getCurrentIndex() - 1); }
